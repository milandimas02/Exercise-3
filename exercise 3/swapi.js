...
for(var x = 0; x < result.length; x++){
	str += "<tr>"
      +"<th scope="+"row>" + result[x].name + "</th>"
      +"<td>"+ result[x].rotation_period+"</td>"
      +"<td>"+result[x].orbital_period+"</td>"
      +"<td>"+result[x].diameter+"</td>"
      +"<td>"+result[x].climate+"</td>"
      +"<td>"+result[x].gravity+"</td>"
      +"<td>"+result[x].terrain+"</td>"
      +"<td>"+result[x].surface_water+"</td>"
      +"<td>"+result[x].population+"</td>"
    +"</tr>"
}
...
(function(document) {
	...
	var LightTableFilter = (function(Arr) {
		...
		return {
			init: function() {
				var inputs = document.getElementsByClassName('form-control mr-sm-2');
